...
def main():
    ...
    bibliotek.läggTill("William Shakespeare", "Romeo och Julia (1594-1595)")
    bibliotek.läggTill("Joseph Heller", "Catch 22 (1953-1960)")
    bibliotek.läggTill("John Kennedy Toole", "A Confederacy of Dunces (1963)")
    bibliotek.läggTill("Douglas Adams", "The Hitchhikers Guide to the Galaxy (1981)")
    bibliotek.läggTill("Douglas Adams", "The Restaurant at the End of the Universe (1980)")
    bibliotek.läggTill("Douglas Adams", "Life, the Universe and Everything (1982)")
    bibliotek.läggTill("Douglas Adams", "So Long, and Thanks for All the Fish (2018)")
    bibliotek.läggTill("Douglas Adams", "Mostly Harmless (1992)")
    bibliotek.läggTill("Isaac Asimov", "I Robot (1950)")
    bibliotek.läggTill("Miguel Cervantes", "Don Quixote (1604)")
    bibliotek.läggTill("Leo Edling", "Kiss Boken (2024)")
    bibliotek.läggTill("Nicole Dvali", "Bajs Boken (2024)")
    bibliotek.läggTill("Nicole Dvali, Leo Edling", "Kiss och Bajs Boken (2024)")
    bibliotek.läggTill("F. Scott Fitzgerald", "The Great Gatsby (1925)")
    bibliotek.läggTill("Leo Tolstoy", "Anna Karenina (1873-1877)")
